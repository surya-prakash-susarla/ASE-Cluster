...
class Num:
    ...
    def print(self):
        ...
        print_st = print_st.format(self.at, self.max, self.min, round(
            self.m2, 2), round(self.mu, 2), self.txt, self.wt, self.n, self.mid())
        print(print_st)
    ...
    def add(self, value):
      try:
        ...
        print("Could not add value to syms : ", value)
